...
const ProductDetails = () => {
	const { id } = useParams();
	const { data: prod } = UserOneProductQuery(id);
	const { data: cate } = UsequeryCategory(prod?.category);
				...
				<div className="w-full h-auto flex justify-center py-[100px] px-[100px]">
					<div className="w-full h-full flex flex-col gap-5">
						<div className="w-full h-[370px] flex justify-center items-center">
							<img src={prod?.image} alt="" className="w-[355px] h-[355px]" />
						</div>
						...
						<div className="w-full h-[106px] flex justify-center gap-5">
							...
							/>
							<img src={prod?.image} alt="" className="w-[106px] h-[106px]" />
							<img src={prod?.image} alt="" className="w-[106px] h-[106px]" />
						</div>
					</div>
					<div className="w-full h-full">
						<div>
							<span className="text-[16px] text-[#4E7C32] font-bold">{cate?.name}</span>
						</div>
						<div className="mt-3 w-3/4">
							<span className="text-[44px] text-[#1D2025] font-bold">{prod?.name}</span>
						</div>
						<div className="mt-3 w-3/4">
						...
						<div className="flex mt-3 items-center gap-3">
							<div className="text-[30px] font-bold">{prod?.price} $</div>
				...
				<div className="flex flex-col md:flex-row gap-8 items-center">
					<div className="flex-1 text-center md:text-left">
						<p className="text-gray-600">
							Get weekly updates about our product in your email. No spam guaranteed—we
							promise ✌️
						</p>
					</div>
